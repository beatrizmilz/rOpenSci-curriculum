---
pagetitle: "rOpenSci — Orientação e capacitação para mentoras e mentores"
lang: pt
format:
  revealjs:
    css: theme.css
...
*rOpenSci*\
**Programa de Campeãs e Campeões**
:::

::: {style="text-align:center; margin-top:0.3em;"}
**Orientação e capacitação para mentoras e mentores**
...
## Reflexão sobre a mentoria {background-color="#447BCD"}
...
:::
::: {.column width="35%"}
<img src="images/ilustracion-mentoria-reflexion.png" alt="Uma mulher segura um gato em seu escritório">
:::
::::

::: {.notes}
Como foi essa relação? Em que ela te ajudou? O que mudou para você graças a essa relação?
O que seu mentor (ou mentora) disse ou fez que foi útil para você?
O que deu certo/o que foi útil?
O que não funcionou?
Pense em um problema sobre o qual você gostaria de receber orientação neste momento.
:::

## O que fazem as/os mentores?

:::: {.columns}
::: {.column width="30%"}
<img src="images/ilustracion-mentores.png" alt="Uma mulher com uma rede de borboletas usando um lenço na cabeça">
:::
::: {.column width="68%"}
As pessoas que atuam como mentoras **orientam** e **inspiram**.
...
::: {.column width="54%"}
- Tente ser útil
- Seja específico. Concentre-se em comportamentos observáveis
- Fale por si
...
::: {.notes}
O feedback pode ser uma forma de dar conselhos. Ele também permite que todo mundo cresça.
...
- **Reality (realidade):** autoavaliação, exemplos concretos
- **Options (opções):** sugestões oferecidas e opções escolhidas
- **Way forward (caminho a seguir):** próximos passos
...
- Vocês vão trabalhar em grupos.
- Pratiquem o modelo GROW. Uma pessoa vai fazer o papel de mentor ou mentora, e a outra, o de campeã ou campeão. Usem o tema sobre o qual vocês disseram precisar de ajuda na primeira pergunta.
:::
::: {.column width="35%"}
<img src="images/ilustracion-mentoria-reflexion.png" alt="Uma mulher segura um gato em seu escritório">
:::
...
- Mesmo sendo especialista, seu papel é facilitar
:::
::::

## Dicas de mentores e mentoras anteriores

::: {style="font-size:0.75em;"}
- *Deixe a pessoa que você mentora falar mais do que você e, acima de tudo, incentive essa pessoa na direção de que ela precisa.*
...
- *Conversar mais com os outros mentores e mentoras.*
- *Promova um contato regular com quem você mentora. Converse com frequência e sobre outros assuntos além do programa.*
:::

## Dicas de mentores e mentoras anteriores

::: {style="font-size:0.62em;"}
- *Eu recomendaria a quem faz mentoria que participassem do maior número possível de sessões de treinamento e de coworking. Se possível, conhecer pessoalmente quem você mentora também pode ser extremamente benéfico para construir um relacionamento melhor.*
...
- *Mantenha um relacionamento enriquecedor com quem você mentora, tanto do ponto de vista técnico quanto não técnico.*
- *O conhecimento técnico é importante, mas muitas vezes é menos importante do que dedicar tempo para compreender de verdade o projeto e os objetivos da pessoa que você mentora. Concentre-se em apoiar o sucesso dessa pessoa, ouvindo com atenção e ajudando-a a encontrar o melhor caminho a seguir.*
:::
...
:::
::: {.column width="65%"}
### [Guia para Mentoras e Mentores](https://ropensci-org.github.io/champions-mentor-guidelines/)
...
- [Código de Conduta](https://ropensci.org/pt/c%C3%B3digo-de-conduta/)
- Canais no Slack
- [Google Drive](https://drive.google.com/drive/folders/1W_qXERn2-i-aLqb-Lb9wJFvFYdGLgH4v)
:::
::::

## Perguntas e respostas {background-color="#447BCD"}

:::: {.columns}
::: {.column width="58%"}
**Duração:** ~10 minutos

No documento compartilhado, ao lado do seu nome, responda:

**Você se sente preparada ou preparado para fazer mentoria?**
:::
::: {.column width="35%"}
<img src="images/ilustracion-mentoria-reflexion.png" alt="Uma mulher segura um gato em seu escritório">
:::
...
## Feedback sobre este workshop {background-color="#447BCD"}
