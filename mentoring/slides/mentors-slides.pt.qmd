...
- Vocês vão trabalhar em grupos.
- Pratiquem o modelo GROW. Uma pessoa vai fazer o papel de mentor ou mentora, e o outra, o de campeã ou campeão. Usem o tema sobre o qual vocês disseram precisar de ajuda na primeira pergunta.
:::
::: {.column width="35%"}
<img src="images/ilustracion-mentoria-reflexion.png" alt="Uma mulher segura um gato em seu escritório">
:::
...
- Mesmo sendo especialista, você atua como facilitador(a).
:::
::::
...
:::: {.columns}
::: {.column width="30%"}
<img src="images/ilustracion-mentores.png" alt="Uma mulher com uma rede de borboletas, uma delas usando um lenço na cabeça">
:::
::: {.column width="65%"}
